...
load('FB_ricardo_Noise_44100_Hamming_500_500_SA_50.mat')
G1 = G_sm;
load('FB_patricio_Noise_44100_Hamming_500_500_SA_50.mat')
G2 = G_sm;
load('FB_demian_Noise_44100_Hamming_500_500_SA_50.mat')
G3 = G_sm;
...
title_cell =     {  ['Comparison between users'],...
...
grid minor
axis tight
legend('Ricardo','Patricio','Demian')
title(title_cell)
...
print(f1,'Comparison users','-dpdf')
disp('File Printed')
